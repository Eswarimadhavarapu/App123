...
let connectToDB=async()=>{
  try{
    mongoose.connect("mongodb+srv://eswarimadhavarapu0912:eswari@cluster0.wgm667m.mongodb.net/UsersData?retryWrites=true&w=majority")
...
app.put("/updateProfile",upload.single("profilePic"),async(req,res)=>{
  ...
  try{
    ...
    res.json({status:"success", msg:"user details successfully updated"});
...
app.listen(4566,()=>{
  console.log("Listening to port 4566")
})
